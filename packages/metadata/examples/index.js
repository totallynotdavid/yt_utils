...
async function runTest() {
  ...
  await main(
    'https://www.youtube.com/watch?v=7AiSeatxXS4&list=PLwEkAnYJ7sRY6OLAxDBhAlUvPpAi6Am6-&pp=iAQB'
  ) // this is really a video but it's in a playlist
  ...
  // Case 2: Queries
  await main('Oversimplified', 'idOnly')
  await main('omg new jeans', 'idOnly')
}
